...
additional_files = [
    'powerfactory_fmu_install.exe', # installation GUI
    'powerfactory_fmu_install.py', # installation script
    'powerfactory_fmu_create.exe', # GUI for creating a PowerFactory FMU
...
required_binaries = [
    ...
    'binaries\\libboost_filesystem-vc141-mt-x64-1_72.lib', # static BOOST Filesystem library
    'binaries\\libboost_system-vc141-mt-x64-1_72.lib', # static BOOST System library
    'binaries\\libboost_thread-vc141-mt-x64-1_72.lib', # static BOOST Thread library
    'binaries\\libfmipp_fmu_frontend.lib', # static library containing pre-compiled parts of the FMI 1.0 front end
    'binaries\\fmi2.dll', # full implementation of FMI 2.0 front end
    'binaries\\fmiadapter.dll', # to be copied to PowerFactory's bin directory (e.g., C:\DIgSILENT\pf2019)
