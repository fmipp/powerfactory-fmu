...
## > pyinstaller -w -F release\powerfactory_fmu_install_gui.spec
##
...
a = Analysis( [ os.path.join( pf_fmu_root_dir, 'powerfactory_fmu_install_gui.py' ) ],
...
exe = EXE( pyz,
           ...
           gooey_languages,
           gooey_images,
           name = 'powerfactory_fmu_install.exe',
           debug = False,
           strip = None,
           upx = True,
           console = False,
