...
\newcommand{\dslmodel}{DSL model\xspace}
\newcommand{\pfversion}{\pf~2017~SP3~(x86)}
...
\noindent Copyright \copyright\ 2016-2018 AIT Austrian Institute of Technology\\ % Copyright notice
...
\input{chapters/naming_convention}
\input{chapters/export}
\input{chapters/additional_output}
