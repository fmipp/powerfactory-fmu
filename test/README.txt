...
python ..\powerfactory_fmu_create.py -v -m PFTestTriggers -p TestTriggers.pfd -i TestTriggers-inputs.txt -o TestTriggers-outputs.txt -t Trigger:60 ElmLod.Load.plini=0.1
